...
- [X] T021 [P] [US2] Add offline mutation persistence coverage for organizer repositories in `shared/src/commonTest/kotlin/org/deafsapps/storeit/data/repository/SyncAwareOrganizerRepositoriesTest.kt`
- [X] T022 [P] [US2] Add sync-status presentation coverage for pending and failed states in `shared/src/commonTest/kotlin/org/deafsapps/storeit/presentation/sync/SyncStatusViewModelTest.kt`
...
- [X] T028A [US2] Integrate `SyncStatusViewModel` into Android and iOS sync indicators and centralize duplicate sync-state mapping in `shared/src/commonMain/kotlin/org/deafsapps/storeit/presentation/sync/model/SyncStatusUiState.kt`, `androidApp/src/main/java/org/deafsapps/storeit/androidapp/StoreItNavDisplay.kt`, `androidApp/src/main/java/org/deafsapps/storeit/androidapp/presentation/account/ui/AccountScreen.kt`, `iosApp/iosApp/Presentation/ContentView.swift`, and `iosApp/iosApp/Presentation/Account/Views/AccountScreen.swift`
...
- [X] T039 [P] Update feature documentation and add the planned privacy/security document reference in `specs/005-remote-sync-auth/quickstart.md`
- [X] T040 Run quickstart validation scenarios and record final implementation notes in `specs/005-remote-sync-auth/quickstart.md`

...
**Project structure (post-AGP 9.0):** There is no separate `:shared` module. All shared logic and the Android app live in the `:shared` module (commonMain, androidMain, etc.). Plans and tasks must use paths under `shared/` only.
